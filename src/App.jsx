    ...
    <div className="App">
      {!startQuiz ? (
        ...
        <>
          ...
          {currentQuestion === 2 && <QuestionThree onNext={handleNextQuestion} />}
          {currentQuestion === 3 && <QuestionFour onNext={handleNextQuestion} />}
          {currentQuestion === 4 && <QuestionFive onNext={handleNextQuestion} />}
          {currentQuestion === 5 && <QuestionSix onNext={handleNextQuestion} />}
          {currentQuestion === 6 && <QuestionSeven onNext={handleNextQuestion} />}
          {currentQuestion === 7 && <QuestionEight onNext={handleNextQuestion} />}
        </>
      )}
    </div>
  );
